      ...
      <div className="h-[55%] w-full flex flex-col items-center justify-start gap-3">
        <div className="w-full gap-3 flex justify-between items-center">
          <div className="bg-[#00000062] w-28 h-28 rounded-2xl flex flex-col justify-center gap-[10px] p-[10px] items-center">
            ...
            <div className="h-full w-[50%] rounded-full bg-[#ffffff59] text-white text-xl flex justify-center rotate-90 items-center"><MdFlight /></div>
              <div className="h-full w-[50%] rounded-full bg-[#ffffff59] text-white text-xl flex justify-center items-center"><FaTowerBroadcast /></div>
            </div>
            <div className="h-[50%] w-full flex justify-center items-center gap-2">
            <div className="h-full w-[50%] rounded-full bg-[#ffffff59] text-white text-xl flex justify-center items-center"><FaWifi/></div>
              <div className="h-full w-[50%] rounded-full bg-[#ffffff59] text-white text-xl flex justify-center items-center"><PiBluetoothBold /></div>
            </div>
          </div>
          <div className="bg-[#00000062] w-28 h-28 rounded-2xl flex flex-col justify-center items-center">
              <div className="w-full h-[50%] flex justify-center items-center text-xs text-[#ffffffa4]">Not Playing</div>
        ...
        <div className="w-full gap-3 flex justify-between items-center">
          <div className="w-full h-full flex flex-col items-center justify-center gap-3">
            <div className="w-full flex justify-between items-center gap-2">
              ...
              <div className="h-full w-[50%] rounded-full text-white text-2xl flex justify-center items-center"><BsHouseLock /></div>
              </div>
              <div className="bg-[#00000062] h-12 w-12 rounded-2xl flex justify-center items-center">
              <div className="h-full w-[50%] rounded-full text-white text-2xl flex justify-center items-center"><MdOutlineDesktopWindows /></div>
              </div>
            </div>
            <div className="bg-[#00000062] h-12 w-full rounded-2xl flex justify-start items-center">
              <div className="h-full flex justify-center items-center p-2"><div className="p-2 rounded-full bg-[#ffffff59] text-white text-xl flex justify-center items-center"><IoMdMoon/></div></div>
              <div className="h-full flex justify-start items-center text-white text-xs">Focus</div>
            </div>
          </div>
          <div className="w-full h-full flex gap-2 justify-between items-center">
            <div className="bg-[#00000062] h-28 w-12 rounded-2xl flex flex-col items-center justify-end p-2 text-white pb-4"><BsSunFill /></div>
            <div className="bg-[#00000062] h-28 w-12 rounded-2xl flex flex-col items-center justify-end p-2 text-white pb-4"><RxSpeakerLoud /></div>
          </div>
        </div>
        <div className="w-full gap-3 flex justify-between items-center">
          <div className="w-full h-full flex justify-between items-center gap-2">
            <div className="bg-[#00000062] h-12 w-12 rounded-2xl flex justify-center items-center">
            <div className="h-full w-[50%] rounded-full text-white text-2xl flex justify-center items-center"><IoIosFlashlight /></div>
            </div>
            <div className="bg-[#00000062] h-12 w-12 rounded-2xl flex justify-center items-center">
            <div className="h-full w-[50%] rounded-full text-white text-2xl flex justify-center items-center"><RxTimer /></div>
            </div>
          </div>
          <div className=" w-full h-full flex justify-between items-center gap-2">
            <div className="bg-[#00000062] h-12 w-12 rounded-2xl flex justify-center items-center">
            <div className="h-full w-[50%] rounded-full text-white text-2xl flex justify-center items-center"><FaCalculator /></div>
            </div>
            <div className="bg-[#00000062] h-12 w-12 rounded-2xl flex justify-center items-center">
            <div className="h-full w-[50%] rounded-full text-white text-2xl flex justify-center items-center"><HiCamera /></div>
            </div>
          </div>
        </div>
      </div>
