...
const NotificationPanel = ({ color }: any) => {
  ...
  return (
    <div
      ...
      }  select-none draggable-none  font-semibold px-3 items-center h-4 w-full z-[40]`}
    >
      <p
        className={`${
      ...
      <div className="text-sm flex items-center justify-center gap-2 font-semibold select-none draggable-none  ">
